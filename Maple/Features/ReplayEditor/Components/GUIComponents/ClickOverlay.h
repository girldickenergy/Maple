...
namespace ReplayEditor
{
	...
	class ClickOverlay
	{
		...
		/// @brief Pointer to the clientBounds containing the osu! size.
	...
	public:
		...
		/// @param clientBounds Pointer to the clientBounds containing the osu! size.
		ClickOverlay(int* timer, std::vector<Click>* clicks, ImDrawList* drawList, sRectangle* clientBounds);
